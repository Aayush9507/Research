...
if __name__ == '__main__':
    ...
    # csv_name = "/Users/mymac/Documents/GitHub/Research/Experiments/CSV's/VersionSnapshot_time_log_large.csv"
    # rows = []
    ...
    #             start = time.time()
        ...
        for i in range(0, len(newdata)):
            ss = populate_data(newdata[i], output_json_arr[input_version], itemname)
